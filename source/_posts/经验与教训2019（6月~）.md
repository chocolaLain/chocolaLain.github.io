...
### 19-07-30  
[强制结束node.exe进程](https://www.baishitou.cn/1882.html)\  
用git执行hexo s后无法用ctrl+c退出,可能是git的一个bug导致进程无法退出node.exe,把git bash集成到vscode,在vscode上运行git一切正常.  
不过即使hexo还在进程中,退出vscode是不会有提示的.  

## 8月  
### 19-08-04  
一点观察和感想:  
一些被部分实时热点激起了情绪尤其是负面情绪的网友,其中一部分强调了性质差异而忽略了程度问题,又有一部分强调了程度对比而忽略了性质问题.这些人看问题的角度感觉有些是因为对事件不够了解造成的,而又有些像是故意的.  

## 9月
### 19-09-22
* 看网课的时候放着vtuber的视频以外的不错
* 平常回顾博客文章的时候也可以看看vtuber
* 看了一话南家
* (SC2019 Summer) ツンデレ彼女が素直になるまでえっち(26P)等以后看
* [免费高清图库？一个 Zoommy 就够了](https://www.jianshu.com/p/34c593360490)
